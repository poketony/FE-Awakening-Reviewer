...
const COLORS = new Map([
  ...
  ["マーク", DEFAULT_HAIR_COLOR], ["マーク男", DEFAULT_HAIR_COLOR], ["マーク女", DEFAULT_HAIR_COLOR],
  ["ルキナ", rgb("#505C81")], ["マルス", rgb("#505C81")],
  ["ウード", rgb("#DAD3BD")], ["ウード正体不明", rgb("#DAD3BD")],
  ["アズール", rgb("#EBCDD6")], ["ブレディ", rgb("#F2E7C4")],
  ["デジェル", rgb("#595655")], ["シンシア", rgb("#A19791")],
  ["セレナ", rgb("#AF5454")], ["ジェローム", rgb("#D48085")],
  ["シャンブレー", rgb("#463E36")], ["ロラン", rgb("#532426")],
  ["ノワール", rgb("#484848")], ["ンン", rgb("#C2D6AE")],
]);
