const CACHE = "fe-awakening-reviewer-v12";
const SHELL = [
  "./", "./index.html", "./styles.css", "./progress.css", "./transition-guard.js", "./token-persistence.js", "./app.js", "./progress.js", "./manifest-v2.webmanifest",
